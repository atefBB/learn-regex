...
التعبير النمطي هو نمط يتم مطابقته مع سلسلة محارف من اليسار إلى اليمين. لفظ «تعبير نمطي» هو عبارة طويلة جدا، من العادة ستجد اللفظ مختصرا بـ«regex» أو «regexp». يستعمل التعبير النمطي لاستبدال نص داخل سلسلة محارف، للتحقق من نموذج، لاستخراج قطعة من سلسلة محارف اعتمادا على تطابق نمط معين، والمزيد.
